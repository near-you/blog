...
<head>
    ...
    <title>{{ $metaTitle ?: 'NearYou blog' }}</title>
    <meta name="author" content="NearYou">
                ...
                @auth
                    ...
                    <div class="flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="hover:bg-blue-600 flex hover:text-white items-center rounded py-2 px-4 mx-2">
                                        {{ Auth::user()->name }}
                                    <div class="ml-1">
...
<footer class="w-full border-t bg-white pb-12">
    <div class="w-full container mx-auto flex flex-col items-center">
        <div class="uppercase py-6">&copy; near-you blog</div>
    </div>
</footer>
